...
{  static int warning_width;
   ...
   text = g_locale_to_utf8(_("<b>Warning</b>: This codec is experimental and for evaluation only. "
   ...
   g_signal_connect(lab, "expose_event", G_CALLBACK(wrapper_fix_cb), &warning_width);
