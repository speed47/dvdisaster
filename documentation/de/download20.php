...
<h3 class="top">Digitale Unterschrift</h3>
...
an <img src="../images/email.png" alt="als Grafik dargestellte E-Mail-Adresse" class="valigntt"> schreiben. Bitte verwenden Sie
